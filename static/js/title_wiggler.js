// https://stackoverflow.com/questions/23600540/move-each-character-of-a-div-based-on-mouse-movement
// http://jsfiddle.net/TiagoMarinho/6fk8H/18/
var chars = $(".masthead").html().split('');
$(".masthead").empty();
for (var i = 0; i < chars.length; i++) {
    $(".masthead").append("<span class='letter" + i + "'>" + chars[i] + "</span>");
    $(".letter" + i).css({
        "position":"relative",
    });
    $(".letter" + i).css({
