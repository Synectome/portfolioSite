...
net.add_node(5, label="Python", value=50, color='#adb5bd')
...
# Generate Edges
net.add_edges([(1, 5), (1, 12), (1, 13), (1, 10), (1, 11)]) #WebDEV ---Add a rel to R/shiny
net.add_edges([(2, 14), (2, 15), (2, 16)]) # GameDEV
net.add_edges([(3, 5), (3, 9), (3, 17)]) # Data Science
net.add_edges([(4, 5), (4, 6), (4, 7), (4, 8)]) # SoftwareDEV
